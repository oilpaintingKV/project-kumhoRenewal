...
<head>
	...
	$(document).ready(function() {
         ...
         $(".find").click(function() {    // id입력 상자에 id값 입력시
            ...
            $.ajax({
                type: "POST",
                url: "find.php", // 들어갈 php 
                data: "name=" + name + "&hp1=" + hp1 + "&hp2=" + hp2 + "&hp3=" + hp3,  /* 매개변수 id도 같이 넘겨줌*/
                cache: false, 
...
<header>
    ...
    <article id="content">
        ...
        <form name="find" method="post" action="find.php"> 
            <ul>
                <li><input type="text" name="name" class="find_input" id="name" placeholder="이름을 입력하세요"></li>
                <li class="hp">
