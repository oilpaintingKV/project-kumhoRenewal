  ...
  */
  ...
  암호화된 pass가 입력된 pass의 암호화와 일치하는가를 확인해야함*/
        ...
        function generateRandomPassword($length=8, $strength=0) {
            $vowels = 'bdghjmnpqrstvz';
            $consonants = '0123456789';  //랜덤으로 뽑아낼 기본 문자
            if ($strength & 1) {
                $consonants .= '!!!###@@@';  //추가할 문자
            }
        ...
        echo " 
           <script>
              ...
              <p><span>$name</span>회원님 가입정보입니다.</p>
              <div class='info'>
                  회원님의 임시비밀번호는 <strong> $ranpass </strong> 입니다.
              </div>
              <dl>
                  <dt>아이디</dt>
                  <dd>$id</dd>
              ...
              <a href='#' class='close'><span class='hidden'>닫기</span></a>
           ";
