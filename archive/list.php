        ...
        <article id="content">
            ...
            <div class="contentArea">
				...
				<div class="listWrap">
					...
					<div class="listSort">
						<div class="listInfo">
							<p> 총 <?= $total_record ?> 명의 금호예술인이 존재합니다. </p>
						</div>
						...
						<ul class="listStyle">
							<li class="active"><a href="list.php?liststyle=list&scale=<?=$scale?>"><span class="hidden">목록형으로보기</span><i class='fa-solid fa-table-list'></i></a></li>
							<li><a href="list.php?liststyle=box&scale=<?=$scale?>"><span class="hidden">박스형으로보기</span><i class='fa-solid fa-table-cells-large'></i></a></li>
						</ul>
					...
					<div class="listBody">
						...
						?>
							<li class="listItem">
							<a href="view.php?table=<?=$table?>&num=<?=$item_num?>&scale=<?=$scale?>&page=<?=$page?>&liststyle=<?=$liststyle?>">
									<div class="image"><img src="<?=$item_img?>" alt="첨부된 이미지"></div>
									<div class="listTxt">
					...
					<div class="searchWrap">
						<form name="board_form" method="post" action="list.php?table=<?=$table?>&mode=search&liststyle=<?=$liststyle?>">
							<div class="listSearch">
									<select name="find">
										<option value='category_1'>악기</option>
										<option value='category_2'>레벨</option>
